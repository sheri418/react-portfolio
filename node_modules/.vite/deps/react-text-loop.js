...
var require_performance_now = __commonJS({
  "node_modules/react-motion/node_modules/performance-now/lib/performance-now.js"(exports, module) {
    (function() {
...
var require_TransitionMotion = __commonJS({
  "node_modules/react-motion/lib/TransitionMotion.js"(exports, module) {
    ...
    var TransitionMotion2 = function(_React$Component) {
      ...
      _createClass(TransitionMotion3, null, [{
        key: "propTypes",
        value: {
      ...
      function TransitionMotion3(props) {
        var _this = this;
        _classCallCheck(this, TransitionMotion3);
        _React$Component.call(this, props);
...
var require_dist = __commonJS({
  "node_modules/cxs/dist/index.js"(exports, module) {
    "use strict";
    var cache = {};
    var prefix = "x";
    var rules = [];
    var insert = function insert2(rule) {
      return rules.push(rule);
    };
    var hyph = function hyph2(s) {
      return s.replace(/[A-Z]|^ms/g, "-$&").toLowerCase();
    };
    var mx = function mx2(rule, media) {
      return media ? media + "{" + rule + "}" : rule;
    };
    var rx = function rx2(cn, prop, val) {
      return "." + cn + "{" + hyph(prop) + ":" + val + "}";
    };
    var noAnd = function noAnd2(s) {
      return s.replace(/&/g, "");
    };
    var parse = function parse2(obj) {
...
var import_cxs = __toESM(require_dist());
...
var requestTimeout = function requestTimeout2(fn, delay) {
...
var clearRequestTimeout = function clearRequestTimeout2(handle) {
...
var TextLoop = function(_React$PureComponent) {
  _inheritsLoose(TextLoop2, _React$PureComponent);
  function TextLoop2(_props) {
    var _this;
    ...
    _defineProperty(_assertThisInitialized(_this), "willLeave", function() {
      var _this$getDimensions = _this.getDimensions(), height = _this$getDimensions.height;
      return {
        opacity: (0, import_react_motion.spring)(_this.getOpacity(), _this.props.springConfig),
        translate: (0, import_react_motion.spring)(-height, _this.props.springConfig)
      };
    });
    _defineProperty(_assertThisInitialized(_this), "willEnter", function() {
      var _this$getDimensions2 = _this.getDimensions(), height = _this$getDimensions2.height;
      return {
      ...
      if (!_this.isUnMounting) {
        _this.setState(function(state, props) {
          ...
          var updatedState = {
            currentWordIndex,
            currentEl,
            wordCount: (state.wordCount + 1) % 1e3,
    ...
    _defineProperty(_assertThisInitialized(_this), "wrapperStyles", (0, import_cxs.default)(_extends({}, _this.props.mask && {
      overflow: "hidden"
    }, {}, {
    ...
    _defineProperty(_assertThisInitialized(_this), "elementStyles", (0, import_cxs.default)({
      display: "inline-block",
      left: 0,
      top: 0,
      whiteSpace: _this.props.noWrap ? "nowrap" : "normal"
    }));
    var elements = import_react.default.Children.toArray(_props.children);
    _this.state = {
      elements,
  ...
  var _proto = TextLoop2.prototype;
  _proto.componentDidMount = function componentDidMount() {
    var _this2 = this;
    var delay = this.props.delay;
    var _this$state = this.state, currentInterval = _this$state.currentInterval, elements = _this$state.elements;
  ...
  _proto.componentDidUpdate = function componentDidUpdate(prevProps, prevState) {
    var _this3 = this;
    var _ref = this.props, interval = _ref.interval, children = _ref.children, delay = _ref.delay;
    ...
    if (prevState.currentInterval !== currentInterval) {
      this.clearTimeouts();
      if (currentInterval > 0 && import_react.default.Children.count(children) > 1) {
        this.tickDelay = requestTimeout(function() {
    ...
    if (!(0, import_react_fast_compare.default)(prevProps.children, children)) {
      this.setState({
        elements: import_react.default.Children.toArray(children)
      });
    }
  };
  ...
  _proto.getTransitionMotionStyles = function getTransitionMotionStyles() {
    ...
    var _this$state2 = this.state, wordCount = _this$state2.wordCount, currentEl = _this$state2.currentEl;
    return [{
      key: "step-" + wordCount,
      data: {
        currentEl
      ...
      style: {
        opacity: (0, import_react_motion.spring)(1, springConfig),
        translate: (0, import_react_motion.spring)(0, springConfig)
      }
    }];
  };
  _proto.render = function render() {
    var _this4 = this;
    var _this$props$className = this.props.className, className = _this$props$className === void 0 ? "" : _this$props$className;
    return import_react.default.createElement("div", {
      className: this.wrapperStyles + " " + className
    }, import_react.default.createElement(import_react_motion.TransitionMotion, {
      willLeave: this.willLeave,
      willEnter: this.willEnter,
      styles: this.getTransitionMotionStyles()
    }, function(interpolatedStyles) {
      var _this4$getDimensions = _this4.getDimensions(), height = _this4$getDimensions.height, width = _this4$getDimensions.width;
...
var TextLoop_default = TextLoop;

// node_modules/react-text-loop/es/index.js
var es_default = TextLoop_default;
export {
